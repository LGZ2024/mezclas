...
const iniciarMesclasVS = async (status) => {
    try {
...
/*funciones para inicializar tabla  de mezclas solicitadas*/
/*inicializar tabla solicitada*/
const iniciarMesclasVPS = async (status) => {
    try {
        const data = await obtenerMesclaz(status);
...
/*inicializar tabla solicitada*/
const iniciarMesclasVPES = async (status) => {
    try {
        const data = await obtenerMesclaz(status);
...
export { iniciarMesclasVS, verMesclazVS, iniciarMesclasVPS, verMesclazVPS, iniciarMesclasVPES, verMesclazVPES };
