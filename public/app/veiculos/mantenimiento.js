$(document).ready(function () {
    ...
    const tabla = $('#tablaMante').DataTable({
        paging: true,
        ...
        columnDefs: [
            ...
            { "targets": -1, "data": "idMantenimiento", className: "ocultar" },
...
const iniciarDivs = async () => {
    try {
        ...
        var table = $('#tablaMante').DataTable();
...
const obtenerDatos = async () => {
    try {
        const response = await fetch(`../../view/crud/DatosTabla.php?op=5`);
        if (!response.ok) {
