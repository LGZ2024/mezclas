$(document).ready(function () {
    ...
    const tabla = $('#soliServicio').DataTable({
        paging: true,
        ...
        columnDefs: [
            ...
            { "targets": 2, "data": "tipo_vehiculo", },
            { "targets": 3, "data": "tipo_servicio", },
            { "targets": 4, "data": "fecha_ingreso", },
            { "targets": 5, "data": "prioridad", },
            { "targets": 6, "data": "taller_servicio", },
            { "targets": 7, "data": "kilometraje", },
            { "targets": 8, "data": "pxmservicio" },
            { "targets": 9, "data": "fechasalida" },
            { "targets": 10, "data": "tipo_doc" },
        ...
        "createdRow": function (row, data, index) {
            ...
            } else if (data.tipo_servicio === 'Correctivo') {
                $('td', row).eq(3).css({
                    'background-color': '#FF4233',
                    'color': 'black'
                })
...
const iniciarDivs = async () => {
    try {
        ...
        var table = $('#soliServicio').DataTable();
...
const obtenerDatos = async () => {
    try {
        const response = await fetch(`../../view/crud/DatosTabla.php?op=8`);
        if (!response.ok) {
